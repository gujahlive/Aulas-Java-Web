...
<body>
	<%
		...
		if(nome!=null){//se o nome for diferente de nulo é pq ele já passou pelo cadastro
			Cookie cookie = new Cookie("nomeUsuario",nome);//objeto cookie passa sempre 2 valores por parametro
			// que é o nome unico para cada cokie e o valor que é passado no caso na variavel 
		...
		for(Cookie atual: cookies){
			if(atual.getName().equals("nomeUsuario")){
				nome = atual.getValue();// atual é o cookie do foreach que recebe o valor que vem do submit
			}
		}
